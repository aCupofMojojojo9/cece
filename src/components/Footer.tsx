      ...
      >
        ...
        <Box sx={{ width: { xs: '100%', md: '33.33%' },
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', mb: 1, justifyContent: 'center' }}>
            ...
            <Typography variant="body2" color="white">{content.contact.address}</Typography>
          </Box>
          <Box sx={{ display: 'flex', alignItems: 'center', mb: 2, justifyContent: 'center' }}>
            <EmailIcon sx={{ mr: 1, color: 'white' }} />
            <Typography variant="body2" color="white">{content.contact.email}</Typography>
          </Box>
          <Button variant="contained" sx={{backgroundColor: 'rgb(255, 222, 89)', color: 'black', width: '200px', fontWeight: 700, mt: 'auto'}} href={content.contact.donateUrl} target="_blank">{content.contact.donateButtonLabel}</Button>
        </Box>
      </Box>
